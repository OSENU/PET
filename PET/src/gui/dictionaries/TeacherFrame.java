...
public class TeacherFrame extends javax.swing.JFrame {
    ...
    public TeacherFrame() {
        ...
        if (!ConfigureProgramm.isDEBAG()) {
            ...
            util.TablesUtil.hideColumn(jTableTeacher, 0);
            util.TablesUtil.hideColumn(jTableTeacher, 4);
        }
    }
    ...
    private void initComponents() {
        ...
        jCheckBoxAlwaysOnTop.setText("Поверх всех окон");
    ...
    private void jCheckBoxAlwaysOnTopActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBoxAlwaysOnTopActionPerformed
        TeacherFrame.this.setAlwaysOnTop(jCheckBoxAlwaysOnTop.isSelected());
